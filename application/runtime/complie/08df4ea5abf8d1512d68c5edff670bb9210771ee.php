            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-horizontal" id="form">
                        ...
                        <div class="hr-line-dashed"></div>
                        <?php /*<div class="form-group hide"><label class="col-sm-2 control-label">同步到ldap</label>*/ ?>
                            <?php /*<div class="col-sm-10"><label class="checkbox-inline">*/ ?>
                                <?php /*<input type="radio" name="sync_user"  value="1"> 是</label> <label class="checkbox-inline">*/ ?>
                                <?php /*<input type="radio" name="sync_user" checked="checked" value="0"> 否</label></div>*/ ?>
                        <?php /*</div>*/ ?>
